...
<input type="text" id="date" aria-invalid="true" aria-describedby="date-error">
...
<p id="char-table-desc">Unicode entity codes used to render common special characters in HTML.</p>
```
