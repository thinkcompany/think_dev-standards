  ...
  return (
    <Layout>
      ...
      <div className={styles.NavGrid}>
        ...
        <Link to="/git/" className={styles.linkCard}>
          <div className={styles.LandingPageCard}>
            <div className={styles.iconContainer}>
              <svg
                aria-hidden="true"
            ...
            <h3>Git</h3>
            <p>Git standards and practices</p>
          </div>
        </Link>
        <Link to="/html/programming-principles/" className={styles.linkCard}>
          <div className={styles.LandingPageCard}>
            <div className={styles.iconContainer}>
              <svg
                aria-hidden="true"
        ...
        <Link to="/quality-assurance/" className={styles.linkCard}>
          <div className={styles.LandingPageCard}>
            <div className={styles.iconContainer}>
              <svg
                aria-hidden="true"
            ...
            <p>Trustworthy is delightful</p>
          </div>
        </Link>
        <Link to="/sass/" className={styles.linkCard}>
          <div className={styles.LandingPageCard}>
            <div className={styles.iconContainer}>
              <svg
                aria-hidden="true"
